        ...
        <div className="outlet">
            ...
            <div className="contactme">
                ...
                <div className="contactlist">
                    <img className="contacticon" src="/portfolio/twittericon.png" alt="" />
                    <img className="contacticon" src="/portfolio/linkedinicon.png" alt="" />
                    <img className="contacticon" src="/portfolio/emailicon.png" alt="" />
                </div>
                <div className="contactlist">
